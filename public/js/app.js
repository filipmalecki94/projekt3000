  ...
  $(window).on('resize', function () {
    ...
    if (windowWidth < 768) {
      if ($topMenu.hasClass("active")) {
        ...
        if (!accordionActive) {
          var Accordion2 = function Accordion2(el, multiple) {
            this.el = el || {};
            this.multiple = multiple || false; // Variables privadas

            var links = this.el.find('.movable .link'); // Evento
...
__webpack_require__(/*! D:\xampp\htdocs\projekt3000\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! D:\xampp\htdocs\projekt3000\resources\sass\app.scss */"./resources/sass/app.scss");
